...
from azure.cli.core.commands.parameters import (
    get_resource_name_completion_list, tags_type, get_location_type, get_three_state_flag)
...
def load_arguments(self, _):
    ...
    with self.argument_context('network vpn-site', arg_group='BGP Peering') as c:
